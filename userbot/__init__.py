...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/rakibul-ce-bd/oub-remix")
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("I'm [oub-remix](https://github.com/rakibul-ce-bd/oub-remix) modules helper...\nI only listen to my boss!")
            else:
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@UserButt"):
                ...
                result = builder.article(
                    "oubremix",
                    text="""Hello! I'm your assistant bot; if you need help, check below links for support.""",
                    buttons=[
                        [
                            custom.Button.url(
                                "GitHub Repo",
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # pylint:disable=E0602
                ...
                reply_pop_up_alert = "Error: Only owner can execute this command."
